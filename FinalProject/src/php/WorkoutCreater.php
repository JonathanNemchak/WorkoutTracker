<?php
	...
	try {
		$sql = "INSERT INTO indworkouts (username, Date,workout1, workout2, workout3,workout4,workout5,workout6) VALUES
            (:username,:Date,:workout1,:workout2,:workout3,:workout4,:workout5,:workout6)";  
